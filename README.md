...
* ⚙️ **Low-level systems understanding**
* 🔁 **Autonomous learning**
...
## Skills developed at 42 common core {#skills-developed}

This repository gathers all the projects completed during the **Common Core**.

It represents my growth as a developer:
from the fundamentals of C programming to more complex systems involving algorithms, memory management, and software architecture.

Each project is:

* 📂 organized in its own directory
* 📄 fully implemented in source code
* 🧪 tested according to 42 standards
* 🔗 directly accessible from the index below
...
This journey is not just about coding.

It's about learning how to **face problems without immediate answers**,
staying inside complexity, and building solutions from scratch.
